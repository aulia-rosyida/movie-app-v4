...
import com.dicoding.auliarosyida.academy.databinding.ItemsBookmarkBinding
...
class BookmarkAdapter(private val callback: BookmarkFragmentCallback)  : PagedListAdapter<CourseEntity, BookmarkAdapter.CourseViewHolder>(DIFF_CALLBACK) {
    ...
    /** getSwipedData nantinya akan digunakan untuk aksi swipe di RecyclerView Bookmark */
